...
* Master branch: Production version (copy of [fhem/fhem-mirror/blob/master/fhem/FHEM/70_ENIGMA2.pm](https://github.com/fhem/fhem-mirror/blob/master/fhem/FHEM/70_ENIGMA2.pm))
...
Identified bugs and feature requests are tracked using [Github Issues](https://github.com/fhem/ENIGMA2/issues).
